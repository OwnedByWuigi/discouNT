...
HRESULT WINAPI SHGetSpecialFolderLocation(HWND h,int id,LPITEMIDLIST*out){(void)h;if(!out)return E_POINTER;*out=make_pidl(id==CSIDL_CONTROLS?L"/SYSTEM32":L"/");return *out?S_OK:E_OUTOFMEMORY;}
